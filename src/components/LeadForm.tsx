    ...
    <div className={`bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border border-neutral-100 relative overflow-hidden ${className}`}>
      ...
      <div className="relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-heading font-bold text-neutral-900 mb-3 bg-gradient-to-r from-neutral-900 to-primary-700 bg-clip-text text-transparent">
            {title}
          </h2>
